defmodule Nerdbeers.Repo do
  use Ecto.Repo, otp_app: :nerdbeers
   ...
   def log(log_entry) do
     ...
     :ok = :exometer.update ~w(nerdbeers ecto query_queue_time)a, (log_entry.queue_time || 0) / 1_000 # Note: You will have to add this to conf/exometer.exs if you want it
